...
export default class Serverlist extends React.Component {
    ...
    async componentDidMount() {
        ...
        // script.src = '//cdn.carbonads.com/carbon.js?zoneid=1673&serve=C6AILKT&placement=rnetbotnet';
    ...
    render() {
        ...
        const title = (this.props.isMainPage) ? 'RNet. Discord Platform' : 'Discord Servers';
        return (
            <div>
                <div className="container serverlist serverlist-staff">
                    {this.props.isMainPage &&
                        <img className="home-logo" src="https://s.rnet.cf/web-assets/landing/logo.png" />
                    }
