    ...
    <div>
      <div className="hero hero-small">
        <div className="hero-content">
          <h1 className="title">RNet Plans</h1>
          <p className="has-text-grey is-size-6">Upgrading to RNet Premium or purchasing server listings help support the development and operation of RNet, as well as providing you with a higher level of service and features.</p>
