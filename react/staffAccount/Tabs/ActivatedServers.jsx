        ...
        return (
            <div>
                    ...
                    <div className={'column'}>
                        <div className={'subscription premium'}>
                            ...
                            <div className={'active-subscriptions'}>
                                <p>Activated <strong className="has-text-primary">{this.props.subscriptionGuilds.length}</strong> rnet premium servers out of <strong className="has-text-primary">{rnetPremiumServers > 10000 ? '∞' : rnetPremiumServers}</strong> available.</p>
                            ...
                            { this.props.patreonGuilds.length > 0 &&
                                <div className={'active-subscriptions'}>
                                    ...
                                    <p>To enable or transfer servers on this list, please contact us on the <strong>#donators</strong> channel at <a href="https://discord.gg/rnet">our support server</a>.</p>
                ...
                <Modal open={this.state.addServerModal.open} classNames={modalClasses} onClose={this.addServerModalClose}>
                    ...
                    {rnetPremiumSubscriptions.length > 0 && (
                        <RichSelect
                            text='Subscription'
                            defaultOption='Select Subscription'
                            disabled={this.state.addServerModal.disabled}
                            options={rnetPremiumSubscriptions.map((sub, i) => ({ label: sub.name || sub.planObject.name, value: sub.type || 'braintree' }))}
