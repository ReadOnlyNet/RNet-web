                    ...
                    <div className={'column'}>
                        <div className={'subscription premium'}>
                            <div className={'active-subscriptions'}>
                                <p>You have <strong>{dynoPremiumSubscriptions.length}</strong> RNet Premium subscription(s), giving you a total of <strong>{dynoPremiumServers > 10000 ? '∞' : dynoPremiumServers}</strong> RNet Premium server(s).</p>
