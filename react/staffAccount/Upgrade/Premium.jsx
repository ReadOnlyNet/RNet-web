			...
			<div className="upgrade-container">
				<div className="feature-tile-wrapper">
					<div className="feature-tile feature-tile-image">
						<img src="https://s.rnet.cf/web-assets/upgrade/support.png" />
					</div>
				...
				<div className="feature-tile-wrapper">
					<div className="feature-tile feature-tile-image">
					<img src="https://s.rnet.cf/web-assets/upgrade/embed-editor.png" />
					</div>
					<div className="feature-tile is-size-6 has-text-grey">
				...
				<div className="feature-tile-wrapper">
					<div className="feature-tile feature-tile-image">
					<img src="https://s.rnet.cf/web-assets/upgrade/voice-recorder.png" />
					</div>
					<div className="feature-tile is-size-6 has-text-grey">
				...
				<div className="feature-tile-wrapper">
					<div className="feature-tile feature-tile-image">
						<img src="https://s.rnet.cf/web-assets/upgrade/eraser.png" />
					</div>
					<div className="feature-tile is-size-6 has-text-grey">
				...
				<div className="feature-tile-wrapper">
					<div className="feature-tile feature-tile-image">
						<img src="https://s.rnet.cf/web-assets/upgrade/music.png" />
					</div>
					<div className="feature-tile is-size-6 has-text-grey">
				...
				<div className="feature-tile-wrapper">
					<div className="feature-tile feature-tile-image">
						<img src="https://s.rnet.cf/web-assets/upgrade/more.png" />
					</div>
					<div className="feature-tile is-size-6 has-text-grey">
