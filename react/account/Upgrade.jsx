  ...
  render() {
    ...
    return (<div className="upgrade-container">
      ...
      <div className="feature-tile-wrapper">
        ...
        <div className="feature-tile">
          <h1>Slow mode</h1>
          Busy chat? RNet can limit the number of messages your users can send on an interval. Fully customizable with per-channel rules, user slowmode and channel slowmode!
          </div>
      </div>
      <div className="feature-tile-wrapper">
        <div className="feature-tile feature-tile-image" style={{ flexDirection: 'row' }}>
      ...
      <div className="feature-tile-wrapper big">
        ...
        <div className="feature-tile">
          <h1>And more!</h1>
          Premium users have all feature limits lifted, near perfect uptime, faster response times, better server specs, 2 minute restarts and faster updates! You also get an exclusive role on the RNet server to show off your awesomeness & be granted access to an exclusive channel!
          </div>
      </div>
