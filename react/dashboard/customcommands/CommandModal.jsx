						...
						<div>
							<div className='cc-input-group is-2'>
								...
								<RichSelect
									...
									helpText='The channel RNet will respond in.'
					...
					{this.state.settingsOpen.advOptions && (
						<div>
							<div className='cc-input-group is-3'>
								...
								<div className='control'>
									<label className='label'>Delete After (seconds) <Help text='RNet will delete the command response after a number of seconds. Max 30 seconds.' /></label>
