			...
			<div className="navbar-end is-hidden-touch">
				<div className="navbar-item">
					<div className="buttons">
						<a className="level-item button is-light" href="/invite" title="Add RNet to your server"><strong>Add To Server</strong></a>
			...
			<nav className="navbar" role="navigation" aria-label="main navigation">
				<div className="navbar-brand columns is-vcentered">
					...
					<div className="column navbar-logo-column">
						<a className="navbar-item" href="/">
							<img className="navbar-logo" alt="White diamond shaped RNet logo with RNet written beside it in white" src="https://s.rnet.cf/web-assets/logo.png" />
						</a>
					</div>
				...
				<div className="navbar-menu" style={navbarMenuStyle}>
					<div className="navbar-start">
						...
						<a className="navbar-item" href="/bot" title="RNet Bot">RNet Bot</a>
						<a className="navbar-item" href="/servers" title="Public Servers">Public Servers</a>
						<a className="navbar-item" href="/discord" title="RNet Discord Server" target="_blank">Join Our Discord</a>
						...
						<a className="navbar-item" href="/status" title="RNet Status">Status</a>
						<div className="navbar-item">
							<div className="buttons">
						...
						{/* <a className="navbar-item" href="/team" title="RNet Team">Team</a> */}
						{/* <a className="navbar-item" href="https://twitter.com/RNetDiscord" target="_blank">Twitter</a> */}
					</div>
					{Auth}
				</div>
			</nav>
