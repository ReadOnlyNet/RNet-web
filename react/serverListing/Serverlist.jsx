            ...
            <div>
                <div className="container serverlist">
                    ...
                    {this.props.isMainPage &&
                        <img className="home-logo" alt="White diamond shaped RNet logo" src="https://s.rnet.cf/web-assets/landing/logo.png" />
                    }
                    <div className="columns is-multiline search-container">
                        ...
                        <div className="column is-half is-full-touch ad-container">
                            <div id="ad-1">
                                <GPT
                                    adUnitPath="/22280732/RNetGG_300x250_Other_ATF1"
                                    sizeMapping={[
